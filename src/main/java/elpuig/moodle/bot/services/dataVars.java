...
public class dataVars {
    ...
    public static final String HPDimarts ="http://elpuig.xeill.net/Members/jherna76/horaris/profdimarts/image";
    public static final String HPDimecres ="http://elpuig.xeill.net/Members/jherna76/horaris/profdimecres/image";
    public static final String HPDijous ="http://elpuig.xeill.net/Members/jherna76/horaris/profdijous/image";
    public static final String HPDivendres ="http://elpuig.xeill.net/Members/jherna76/horaris/profdivendres/image";
